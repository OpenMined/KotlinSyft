 ...
 * @param shuffle (Boolean, optional): set to ``True`` to have the data reshuffled
 ...
 */
class DataLoader(var dataset: Dataset, var batchsize: Int = 1, var shuffle: Boolean = false,
                 var sampler: Sampler, var dropLast: Boolean = false) {
